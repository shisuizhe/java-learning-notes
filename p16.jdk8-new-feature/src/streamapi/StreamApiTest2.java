...
public class StreamApiTest2 {
    ...
    public void test1() {
        ...
        System.out.println(noneMatch); // false  因为employees中存在姓马的员工，所以这里匹配到了，而它要的是noneMatch，所以是false
    ...
    public void test2() {
        ...
        System.out.println(maxSalary);       // Optional[10876.12]
        System.out.println(maxSalary.get()); // 10876.12
    ...
    public void test3() {
        ...
        // 使用Lambda
        Integer sum3 = list.stream().reduce(0, (i1, i2) -> Integer.sum(i1, i2));
        System.out.println(sum3); // 55

        // 使用方法引用
        Integer sum4 = list.stream().reduce(0, Integer::sum);
        System.out.println(sum4); // 55
