...
public class ObjectInputOutputStream {
    ...
    public void testObjectOutputStream() {
        ...
        try {
            oos = new ObjectOutputStream(new FileOutputStream("object.bin"));
    ...
    public void testObjectInputStream() {
        ...
        try {
            ...
            System.out.println(p);   // Person{name='王铭', age=23, id=0, acct=null}
            System.out.println(p1);  // Person{name='张学良', age=23, id=1001, acct=Account{balance=5000.0}}
