...
public class StringMethod {
    ...
    */
    ...
    public void test4(){
        ...
        // 判断这是否是一个杭州的固定电话
        boolean result = tel.matches("0571-\\d{7}");
    ...
    */
    ...
    public void test2() {
        ...
        String s62 = new String("abe");
        System.out.println(s5.compareTo(s61)); // -1      --> 涉及到字符串排序
        System.out.println(s5.compareTo(s62)); // -2      --> 涉及到字符串排序
